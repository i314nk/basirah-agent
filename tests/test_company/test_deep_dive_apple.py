"""
Quick test script for deep dive analysis with context management.
"""
import os
...
print("="*80)
print("TESTING DEEP DIVE ANALYSIS WITH CONTEXT MANAGEMENT")
print("="*80)
print()
...
print("1. Analyze current year (2024) 10-K in full detail")
print("2. Analyze 2 prior years (2023, 2022) with summarization")
print("3. Synthesize findings across all 3 years")
print()
...
print("\nStarting deep dive analysis on AAPL...")
print("="*80)
print()

try:
    result = agent.analyze_company("LULU", deep_dive=True)
    ...
    with open('test_deep_dive_apple_result.json', 'w') as f:
    ...
    print("\nFull result saved to: test_deep_dive_apple_result.json")
    print("\nTEST COMPLETE!")
